...
import jwt from 'jsonwebtoken'; // for a claim in jwt
...
export function JWTScopeToken(apiSecret, resource, action) {
...
export function JWTUserSessionToken(apiSecret, userId) {
