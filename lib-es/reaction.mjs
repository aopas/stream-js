...
export var StreamReaction = /*#__PURE__*/function () {
  /**
  ...
  function StreamReaction(client, token) {
    _classCallCheck(this, StreamReaction);

    _defineProperty(this, "client", void 0);

    _defineProperty(this, "token", void 0);

    _defineProperty(this, "buildURL", function () {
    ...
    _defineProperty(this, "_convertTargetFeeds", function () {
  ...
  _createClass(StreamReaction, [{
    ...
    value: function filter(conditions) {
      var userId = conditions.user_id,
          ...
          qs = _objectWithoutProperties(conditions, _excluded);
