...
import { FeedError, SiteError } from "./errors.mjs";
 ...
 * @class StreamFeed
 */
export var StreamFeed = /*#__PURE__*/function () {
  /**
  ...
  function StreamFeed(client, feedSlug, userId, token) {
    _classCallCheck(this, StreamFeed);
    ...
    _defineProperty(this, "feedUrl", void 0);

    _defineProperty(this, "feedTogether", void 0);

    _defineProperty(this, "notificationChannel", void 0);
  ...
  _createClass(StreamFeed, [{
    ...
    value: function subscribe(callback) {
      if (!this.client.appId) {
        throw new SiteError('Missing app id, which is needed to subscribe, use var client = stream.connect(key, secret, appId);');
      }
