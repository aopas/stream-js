...
import { StreamFileStore } from "./files.mjs";
import { StreamImageStore } from "./images.mjs";
import { StreamReaction } from "./reaction.mjs";
import { StreamUser } from "./user.mjs";
import { JWTScopeToken, JWTUserSessionToken } from "./signing.mjs";
import { FeedError, StreamApiError, SiteError } from "./errors.mjs";
import utils from "./utils.mjs";
import BatchOperations from "./batch_operations.mjs";
import createRedirectUrl from "./redirect_url.mjs";
import { StreamFeed } from "./feed.mjs";

/**
 * Client to connect to Stream api
 * @class StreamClient
 */
export var StreamClient = /*#__PURE__*/function () {
  ...
  function StreamClient(apiKey, apiSecretOrToken, appId) {
    ...
    _classCallCheck(this, StreamClient);

    _defineProperty(this, "baseUrl", void 0);

    _defineProperty(this, "baseAnalyticsUrl", void 0);

    _defineProperty(this, "apiKey", void 0);

    _defineProperty(this, "appId", void 0);

    _defineProperty(this, "usingApiSecret", void 0);

    _defineProperty(this, "apiSecret", void 0);

    _defineProperty(this, "userToken", void 0);

    _defineProperty(this, "enrichByDefault", void 0);

    _defineProperty(this, "options", void 0);

    _defineProperty(this, "userId", void 0);

    _defineProperty(this, "authPayload", void 0);

    _defineProperty(this, "version", void 0);

    _defineProperty(this, "fayeUrl", void 0);

    _defineProperty(this, "group", void 0);

    _defineProperty(this, "expireTokens", void 0);

    _defineProperty(this, "location", void 0);

    _defineProperty(this, "fayeClient", void 0);

    _defineProperty(this, "browser", void 0);

    _defineProperty(this, "node", void 0);

    _defineProperty(this, "nodeOptions", void 0);
    ...
    _defineProperty(this, "personalization", void 0);
    ...
    _defineProperty(this, "_personalizationToken", void 0);

    _defineProperty(this, "_collectionsToken", void 0);

    _defineProperty(this, "_getOrCreateToken", void 0);

    _defineProperty(this, "addToMany", void 0);

    _defineProperty(this, "followMany", void 0);

    _defineProperty(this, "unfollowMany", void 0);

    _defineProperty(this, "createRedirectUrl", void 0);

    _defineProperty(this, "replaceReactionOptions", function (options) {
    ...
    _defineProperty(this, "handleResponse", function (response) {
      ...
      throw new StreamApiError("".concat(JSON.stringify(response.data), " with HTTP status code ").concat(response.status), response.data, response);
    });

    _defineProperty(this, "doAxiosRequest", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(method, options) {
        var response, err;
    ...
    if (this.browser && this.usingApiSecret) {
      throw new FeedError('You are publicly sharing your App Secret. Do not expose the App Secret in browsers, "native" mobile apps, or other non-trusted environments.');
    }
    ...
    this.reactions = new StreamReaction(this, this.getOrCreateToken()); // If we are in a node environment and batchOperations/createRedirectUrl is available add the methods to the prototype of StreamClient
  ...
  _createClass(StreamClient, [{
    key: "_throwMissingApiSecret",
    value: function _throwMissingApiSecret() {
      if (!this.usingApiSecret) {
        throw new SiteError('This method can only be used server-side using your API Secret, use client = stream.connect(key, secret);');
      }
    }
  }, {
    ...
    value: function getPersonalizationToken() {
      ...
      this._personalizationToken = JWTScopeToken(this.apiSecret, 'personalization', '*', {
        userId: '*',
        feedId: '*',
    ...
    value: function getCollectionsToken() {
      ...
      this._collectionsToken = JWTScopeToken(this.apiSecret, 'collections', '*', {
        feedId: '*',
        expireTokens: this.expireTokens
      });
    ...
    value: function getAnalyticsToken() {
      ...
      return JWTScopeToken(this.apiSecret, 'analytics', '*', {
        userId: '*',
        expireTokens: this.expireTokens
      });
    }
    ...
    value: function userAgent() {
      return "stream-javascript-client-".concat(this.node ? 'node' : 'browser', "-").concat("8.1.2" || '0.0.0-development');
    }
    /**
    ...
    value: function getReadOnlyToken(feedSlug, userId) {
      ...
      return JWTScopeToken(this.apiSecret, '*', 'read', {
    ...
    value: function getReadWriteToken(feedSlug, userId) {
      utils.validateFeedSlug(feedSlug);
      utils.validateUserId(userId);
      return JWTScopeToken(this.apiSecret, '*', '*', {
        feedId: "".concat(feedSlug).concat(userId),
        expireTokens: this.expireTokens
      });
    }
    ...
    value: function feed(feedSlug, userId, token) {
      ...
      if (token === undefined) {
        if (this.usingApiSecret) {
          token = JWTScopeToken(this.apiSecret, '*', '*', {
            feedId: "".concat(feedSlug).concat(userId)
          });
        } else {
      ...
      return new StreamFeed(this, feedSlug, userId || this.userId, token);
    }
    /**
    ...
    value: function enrichKwargs(_ref2) {
      var method = _ref2.method,
          token = _ref2.token,
          kwargs = _objectWithoutProperties(_ref2, _excluded);
    ...
    value: function upload(url, uri, name, contentType, onUploadProgress) {
      var fd = utils.addFileToFormData(uri, name, contentType);
    ...
    value: function createUserToken(userId) {
      ...
      return JWTUserSessionToken(this.apiSecret, userId, extraData, {
    ...
    value: function updateActivities(activities) {
      ...
      var token = JWTScopeToken(this.apiSecret, 'activities', '*', {
        feedId: '*',
        expireTokens: this.expireTokens
      });
      return this.post({
    ...
    value: function getActivities(_ref3) {
      ...
      if (this.usingApiSecret) {
        token = JWTScopeToken(this.apiSecret, 'activities', '*', {
          feedId: '*',
          expireTokens: this.expireTokens
        });
      }
    ...
    value: function getOrCreateToken() {
      if (!this._getOrCreateToken) {
        this._getOrCreateToken = this.usingApiSecret ? JWTScopeToken(this.apiSecret, '*', '*', {
          feedId: '*'
        }) : this.userToken;
      }
    ...
    key: "setUser",
    value: function () {
      var _setUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(data) {
        var body, user;
    ...
    value: function () {
      var _activityPartialUpdate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(data) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                response = _objectWithoutProperties(_yield$this$activitie, _excluded3);
                _activities = _slicedToArray(activities, 1), activity = _activities[0];
