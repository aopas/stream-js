...
import { SiteError } from "./errors.mjs";
export var CollectionEntry = /*#__PURE__*/function () {
  ...
  _createClass(CollectionEntry, [{
    ...
    key: "add",
    value: function () {
      var _add = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
        var response;
...
export var Collections = /*#__PURE__*/function () {
  /**
  ...
  function Collections(client, token) {
    ...
    _defineProperty(this, "buildURL", function (collection, itemId) {
  ...
  _createClass(Collections, [{
    ...
    key: "get",
    value: function () {
      var _get2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(collection, itemId) {
        var response, entry;
    ...
    key: "add",
    value: function () {
      var _add2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(collection, itemId, itemData) {
        var response, entry;
    ...
    key: "update",
    value: function () {
      var _update2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(collection, entryId, data) {
        var response, entry;
    ...
    value: function upsert(collection, data) {
      ...
      return this.client.post({
        ...
        serviceName: 'api',
        body: {
          data: _defineProperty({}, collection, data)
        },
